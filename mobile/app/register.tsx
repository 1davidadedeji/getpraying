...
export default function RegisterScreen() {
  ...
  const headerMb = Math.round(clamp(32 * uiScale, 26, 38));
  const formGap = Math.round(clamp(14 * uiScale, 12, 16));
    ...
    >
      ...
      >
        ...
        <View style={[styles.form, { gap: formGap }]}>
          ...
          <View style={[styles.field, { gap: fieldGap }]}>
            <Text style={[styles.label, { fontSize: fsLabel }]}>Username</Text>
            <TextInput
              ref={usernameRef}
              style={[
                styles.input,
        ...
        <View style={[styles.footer, { marginTop: footerMt }]}>
          <Text style={[styles.footerText, { fontSize: fsFooter }]}>Already have an account? </Text>
          <Pressable onPress={() => router.replace("/login")}>
            <Text style={[styles.footerLink, { fontSize: fsFooter }]}>Sign In</Text>
          </Pressable>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
