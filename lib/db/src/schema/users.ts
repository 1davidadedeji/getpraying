...
export const usersTable = pgTable("users", {
  ...
  /** Set when a free-tier user uses their one-time Boost. */
  freeBoostUsedAt: timestamp("free_boost_used_at", { withTimezone: true }),
  /** Last time the recurring subscription upsell was shown (Phase 3). */
  subscriptionPromptLastShownAt: timestamp("subscription_prompt_last_shown_at", { withTimezone: true }),
